...
!(function (t, e) {
        ...
        R = (t, e, n) => {
            if (
                ...
                if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach)
                    return void d(
                        "Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(typeof e.customClass[n], '"')
                    );
                K(t, e.customClass[n]);
            }
        },
                ...
                (function (t, e, n) {
                    ...
                    mt(o, "confirm", n),
                        ...
                        (function (t, e, n, o) {
                            ...
                            K([t, e, n], a.styled),
                                o.confirmButtonColor && ((t.style.backgroundColor = o.confirmButtonColor), K(t, a["default-outline"]));
    ...
    const ft = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        kt = (t, e) => {
            ["string", "number"].includes(typeof e)
                ? (t.value = "".concat(e))
                : y(e) || d('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof e, '"'));
        },
        Bt = {};
                ...
                setTimeout(() => {
                    if ("MutationObserver" in window) {
                        ...
                        new MutationObserver(() => {
                            ...
                            const o =
                                t.offsetWidth +
                                ((i = t), parseInt(window.getComputedStyle(i).marginLeft) + parseInt(window.getComputedStyle(i).marginRight));
                            var i;
    ...
    const Et = (t, e) => {
            ...
            n &&
                (R(n, e, "htmlContainer"),
                e.html ? (ct(e.html, n), J(n, "block")) : e.text ? ((n.textContent = e.text), J(n, "block")) : X(n),
                ((t, e) => {
                    const n = A();
                    if (!n) return;
    ...
    const Yt = () => {
        ...
        Jt = t => {
            ...
            return (
                ...
                !Xt(t) &&
                !Gt(t) &&
                (e === n || (!et(n) && e instanceof HTMLElement && "INPUT" !== e.tagName && "TEXTAREA" !== e.tagName && (!et(o) || !o.contains(e))))
            );
        },
    ...
    const se = t => {
        ...
        re = t =>
            void 0 === t ? { isConfirmed: !1, isDenied: !1, isDismissed: !0 } : Object.assign({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t),
        ae = (t, e, n) => {
            const o = w(),
                i = dt && nt(e);
    ...
    function Ze() {
        ...
        e
            ? (t.popup && i.swalCloseEventFinishedCallback && (i.swalCloseEventFinishedCallback(), delete i.swalCloseEventFinishedCallback),
                ...
                "object" != typeof t[0] || rn(t[0])
                    ? ["title", "html", "icon"].forEach((n, o) => {
                          ...
                          "string" == typeof i || rn(i)
                              ? (e[n] = i)
                              : void 0 !== i && p("Unexpected type of ".concat(n, '! Expected "string" or "Element", got ').concat(typeof i));
                      })
                    : Object.assign(e, t[0]),
                e
            );
    ...
    var Ln = {
        email: (t, e) =>
            /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(t) ? Promise.resolve() : Promise.resolve(e || "Invalid email address"),
        url: (t, e) =>
